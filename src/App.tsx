            ...
            <div className='panel h-[70vh] w-4/5 panelalt'>
              ...
              >
                ...
                <div className="w-full lg:w-1/5">
                  <Link to="/pages/AboutTCN" className='panelalt'>
          ...
          <div className='flex flex-col justify-center items-center'>
            <div className='about_tile h-[70vh] w-4/5 panelalt'>
              ...
              >
                ...
                <div className="w-full lg:w-1/5">
                  <Link to="/pages/WorldViewHome " className='panelalt'>
                    <div className="apptext">
                      Learn More
                    </div>
                  </Link>
          ...
          <motion.div 
            ...
            <div className="flex flex-col justify-center items-center p-4">
              <div className='w-full lg:w-4/5'>
                <Link to="/pages/PhotoGallery" className='panelalt'>
            ...
            <div className="flex flex-col justify-center items-center p-4">
              <div className='w-full lg:w-4/5'>
                <Link to="/TCN_Members/TCN_Greet" className='panelalt'>
